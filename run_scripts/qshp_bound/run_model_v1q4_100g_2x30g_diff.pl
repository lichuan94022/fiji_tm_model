...
my $cmd = "gnuplot -e \"set key right center; plot 'run_results.csv' using 1:2 with linespoints title 'q0_shaper: 30G', '' using 1:3 with linespoints title 'q1_shaper: 30G' , '' using 1:4 with linespoints title 'vlan_shaper: 100G'; set term png; set output 'v1q4_100g_2x30g_same.png'; replot; set term x11; \"";
