...
my $cmd = "gnuplot -e \"set key right center; plot 'run_results.csv' using 1:2 with linespoints title 'q0_shaper: 1600B', '' using 1:3 with linespoints title 'q1_shaper: 1600B', '' using 1:4 with linespoints title 'q2_shaper: 1600B', '' using 1:5 with linespoints title 'q3_shaper: 1600B' , '' using 1:6 with linespoints title 'vlan_shaper: 80G'; set term png; set output 'v1q4_80g_1600b.png'; replot; set term x11; \"";
