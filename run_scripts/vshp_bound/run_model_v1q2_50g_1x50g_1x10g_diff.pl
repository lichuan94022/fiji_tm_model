...
my $cmd = "gnuplot -e \"set key right center; plot 'run_results.csv' using 1:2 with linespoints title 'q0_shaper: 50G', '' using 1:3 with linespoints title 'q1_shaper: 10G', '' using 1:4 with linespoints title 'vlan_shaper: 50G'; set term png; set output 'v1q2_50g_1x50g_1x10g_diff.png'; replot; set term x11;\"";
